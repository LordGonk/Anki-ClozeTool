# Created by kylophone (https://github.com/kylophone/neg23), edited for ffmpeg location option 
import os
import sys
import re
import subprocess
import mimetypes
ffmpegLoc = 'C:/ffmpeg/bin/ffmpeg'  # Dont include .exe
